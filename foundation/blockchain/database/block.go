...
type BlockHeader struct {
	...
	// extra hashes on a block header
	StateRoot string `json:"state_root"` // Ethereum: Represents a hash of the accounts and their balances. (hash of the map in database file)
...
func POW(ctx context.Context, args POWArgs) (Block, error) {
	...
	// Peform the proof of work mining operation. (check if nonce is matching)
