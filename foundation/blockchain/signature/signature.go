...
// madiID is an arbitrary number for signing messages. This will make it
...
// the  stamp embedded into the final hash.
...
func toSignatureValues(sig []byte) (v, r, s *big.Int) {
	...
	v = big.NewInt(0).SetBytes([]byte{sig[64] + madiID})
